...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_path', type=str, default='./image/mot.jpg', help='rgb img path')
    parser.add_argument('--mask_path', type=str, default='./image/mot_label.png', help='mask img path')
    ...
    Image.fromarray(result).save(args.img_path[:-4]+'_fusion.png')
