...
@click.command()
@click.option('--data-path', type=str, default='E:/data/VOCdevkit/VOC2012',help='Path to dataset folder')
@click.option('--models-path', type=str, default='./checkpoints', help='Path for storing model snapshots')
...
def train(data_path, models_path, backend, snapshot,
          crop_x, crop_y,
          batch_size, alpha,
          epochs, start_lr,
          milestones, gpu):
